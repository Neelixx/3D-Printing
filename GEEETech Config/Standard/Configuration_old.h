...
#define STRING_CONFIG_H_AUTHOR "(Wachtmeister, Gtech 1.1.8 02212018)" // Who made the changes.
...
// AUTO TUNE Parameters for 210 Grad, GCODE= M303 E-0 S210 C8
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4000, 4000, 120, 4000 }
 ...
 *    (0,0)
 */
 // Einstellung mit Lüfter links und seitlichem Halter: x=-41, y=0, z=-1.45
#define X_PROBE_OFFSET_FROM_EXTRUDER -24   // 10  // X offset: -left  +right  [of the nozzle]
