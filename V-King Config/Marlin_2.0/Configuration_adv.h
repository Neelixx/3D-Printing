 ...
 */
#define BABYSTEPPING						// WAC
#if ENABLED(BABYSTEPPING)
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  #define BABYSTEP_MULTIPLICATOR  10        // WAC Babysteps are very small. Increase for faster motion.

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // WAC Double-click on the Status Screen for Z Babystepping.
